	...
	function generate_page($pageID, $admin = FALSE, $templateID = '')
	{
		...
		if ($blocks)
		{
			foreach($blocks[1] as $block => $value)
			{
				...
				{
					$page[$blockRef] = '
						<div class="feedworldcms_container">
							<div id="'.$blockRef.'" class="feedworldcms_edit">
								<div class="feedworldcms_buttons">
									<a href="#" class="feedworldcms_boldbutton"><img src="'.$this->CI->config->item('staticPath').'/images/btn_bold.png" alt="Bold" title="Bold" class="feedworldcms_helper" /></a>
									<a href="#" class="feedworldcms_italicbutton"><img src="'.$this->CI->config->item('staticPath').'/images/btn_italic.png" alt="Italic" title="Italic" class="feedworldcms_helper" /></a>
									<a href="#" class="feedworldcms_h1button"><img src="'.$this->CI->config->item('staticPath').'/images/btn_h1.png" alt="Heading 1" title="Heading 1" class="feedworldcms_helper" /></a>
									<a href="#" class="feedworldcms_h2button"><img src="'.$this->CI->config->item('staticPath').'/images/btn_h2.png" alt="Heading 2" title="Heading 2" class="feedworldcms_helper" /></a>
									<a href="#" class="feedworldcms_h3button"><img src="'.$this->CI->config->item('staticPath').'/images/btn_h3.png" alt="Heading 3" title="Heading 3" class="feedworldcms_helper" /></a>
									<a href="#" class="feedworldcms_urlbutton"><img src="'.$this->CI->config->item('staticPath').'/images/btn_url.png" alt="Insert Link" title="Insert Link" class="feedworldcms_helper" /></a>
									<a href="'.site_url('/admin/images/browser').'" class="feedworldcms_imagebutton"><img src="'.$this->CI->config->item('staticPath').'/images/btn_image.png" alt="Insert Image" title="Insert Image" class="feedworldcms_helper" /></a>
									<a href="'.site_url('/admin/files/browser').'" class="feedworldcms_filebutton"><img src="'.$this->CI->config->item('staticPath').'/images/btn_file.png" alt="Insert File" title="Insert File" class="feedworldcms_helper" /></a>									
									<a href="#" class="feedworldcms_cancelbutton"><img src="'.$this->CI->config->item('staticPath').'/images/btn_cancel.png" alt="Cancel" title="Cancel Changes" class="feedworldcms_helper" /></a>
									<a href="'.site_url('/admin/pages/add_block/'.$versionID.'/'.$blockRef).'" class="feedworldcms_savebutton"><img src="'.$this->CI->config->item('staticPath').'/images/btn_save.png" alt="Save" title="Save Changes" class="feedworldcms_helper" /></a>
									<a href="#" class="feedworldcms_editbutton">Edit</a>									
								</div>
								<div class="feedworldcms_blockelement">'.@$mkdnBody[$blockRef].'</div>
								<div class="feedworldcms_editblock"><textarea rows="8" cols="10" class="code">'.@$body[$blockRef].'</textarea></div>
							</div>
						</div>
					';
				}
