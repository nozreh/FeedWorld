...
$(function(){
	...
	$('#searchbox').autocomplete("<?php echo site_url('/feedworld/ac_sites'); ?>", { delay: "0", selectFirst: false, matchContains: true, formatItem: formatItem, minChars: 2 });
...
<div class="headingright">
	...
	<form method="post" action="<?php echo site_url('/feedworld/sites'); ?>" class="default" id="search">
	...
	<a href="<?php echo site_url('/feedworld/add_site'); ?>" class="button">Add Site</a>
</div>
...
<table class="default">
	<tr>
		<th><?php echo order_link('feedworld/sites/viewall','siteName','Site Name'); ?></th>
		<th><?php echo order_link('feedworld/sites/viewall','dateCreated','Date Created'); ?></th>
		<th><?php echo order_link('feedworld/sites/viewall','siteDomain','Domain'); ?></th>
		<th><?php echo order_link('feedworld/sites/viewall','altDomain','Staging Domain'); ?></th>		
		<th class="narrow"><?php echo order_link('feedworld/sites/viewall','active','Status'); ?></th>		
		<th class="tiny">&nbsp;</th>
		<th class="tiny">&nbsp;</th>
	</tr>
<?php
...
?>
	<tr<?php echo $class; ?>>
		<td><?php echo anchor('/feedworld/edit_site/'.$site['siteID'], $site['siteName']); ?></td>
		...
		<td class="tiny">
			<?php echo anchor('/feedworld/edit_site/'.$site['siteID'], 'Edit'); ?>
		</td>
		<td class="tiny">
			<?php echo anchor('/feedworld/delete_site/'.$site['siteID'], 'Delete', 'onclick="return confirm(\'Are you absolutely SURE you want to delete this site?\n\nThere is no undo!\')"'); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
