...
<?php else: ?>
	...
	function saveall(el, postform){
		...
		var blocks = ($('#preview').contents().find('a.feedworldcms_savebutton').length);
		var updated = 0;	
		$('#preview').contents().find('a.feedworldcms_savebutton').each(function(){
			var blockElement = $(this).parent().siblings('div.feedworldcms_blockelement');
			var blockForm = $(blockElement).siblings('div.feedworldcms_editblock');	
