...
<div id="details" class="tab">
	...
	<?php endif; ?>	
     ...
     <?php if ($this->site->config['shopStockControl']): ?>
		<label for="stock">Stock Alert Level:</label>
		<?php echo @form_input('stockAlert',set_value('stockAlert', $data['stockAlert']), 'id="stockAlert" class="formelement small"'); ?>
		<br class="clear" />
	<?php endif; ?>	
...
<div id="desc" class="tab">	
	...
	<div class="buttons">
		...
		<a href="<?php echo site_url('/admin/images/browser'); ?>" class="feedworldcms_imagebutton"><img src="<?php echo $this->config->item('staticPath'); ?>/images/btn_image.png" alt="Insert Image" title="Insert Image" /></a>
		<a href="<?php echo site_url('/admin/files/browser'); ?>" class="feedworldcms_filebutton"><img src="<?php echo $this->config->item('staticPath'); ?>/images/btn_file.png" alt="Insert File" title="Insert File" /></a>
