...
<head>
	...
	<title><?php echo (isset($this->site->config['siteName'])) ? $this->site->config['siteName'] : 'Login to'; ?> Admin - FeedWorld</title>
		...
		<div id="header">
			...
			<div id="logo">
				...
				<?php
					...
					else $logo = $this->config->item('staticPath').'/images/feedworld_logo.jpg';
				?>
			...
			<div id="siteinfo">
				<ul id="toolbar">
					...
					<?php if ($this->session->userdata('session_admin')): ?>				
						...
						<?php endif; ?>
						<?php if ($this->session->userdata('groupID') < 0 && @file_exists(APPPATH.'modules/feedworld/controllers/feedworld.php')): ?>
							<li class="noborder"><a href="<?php echo site_url('/admin/logout'); ?>">Logout</a></li>
							<li class="superuser"><a href="<?php echo site_url('/feedworld/sites'); ?>">Sites</a></li>
						<?php else: ?>
				...
				<?php if (in_array('shop', $this->permission->permissions)): ?>
					<li><a href="<?php echo site_url('/admin/shop/products'); ?>">Shop</a>
						<ul class="subnav">
							...
							<?php endif; ?>
                            <?php if (in_array('shop_reports', $this->permission->permissions)): ?>
								<li><a href="<?php echo site_url('/admin/shop/reports'); ?>">View Reports</a></li>
							<?php endif; ?>
